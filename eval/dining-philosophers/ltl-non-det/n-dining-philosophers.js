...
range.forEach(i => {
    wf(`G(philosopher${i}Thinking → X(philosopher${i}Thinking ∨ philosopher${i}HoldingLeftFork)) .\n`);
    wf(`G(philosopher${i}HoldingLeftFork → X(philosopher${i}HoldingLeftFork ∨ philosopher${i}HoldingBothForks)) .\n`);
    wf(`G(philosopher${i}HoldingBothForks → X(philosopher${i}HoldingBothForks ∨ philosopher${i}Eating)) .\n`);
    wf(`G(philosopher${i}Eating → X(philosopher${i}Eating ∨ philosopher${i}ReleasingRightFork)) .\n`);
    wf(`G(philosopher${i}ReleasingRightFork → X(philosopher${i}ReleasingRightFork ∨ philosopher${i}ReleasingLeftFork)) .\n`);
    wf(`G(philosopher${i}ReleasingLeftFork → X(philosopher${i}ReleasingLeftFork ∨ philosopher${i}Thinking)) .\n`);
...
wf('F(' + range.map(i => `philosopher${i}HoldingLeftFork`).join(' ∧ ') + ') .\n');